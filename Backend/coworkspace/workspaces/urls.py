...
path(
    "owner-notification-read/<int:pk>/",
    mark_owner_notification_read
),
path("slots/admin/", admin_all_slots),
path("monthly-slots/admin/", admin_all_monthly_slots),
]