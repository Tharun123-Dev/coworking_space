...
function CreateOwner() {
  ...
  const handleEdit = (owner) => {
    setEditId(owner.id);
    setForm({ username: owner.username, email: owner.email, password: "" });
    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <div className={styles.statsGrid}>
          ...
          <div className={styles.statCard}>
            <div className={`${styles.statIcon} ${editId ? styles.statIconEdit : styles.statIconCreate}`}>
              {editId ? (
          ...
          <div className={styles.card}>
            <div className={styles.cardHeader}>
              ...
              <p className={styles.cardDesc}>
                {editId ? "Update the information below" : "Fill in the details to create a new owner account"}
              </p>
            </div>
            ...
            <div className={styles.form}>
              ...
              <div className={styles.formActions}>
                <button onClick={handleSubmit} className={styles.primaryBtn} disabled={loading}>
                  ...
                  ) : editId ? "Update Owner" : "Create Owner"}
                </button>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.searchStats}>
              <div className={styles.searchStatItem}>
                <span className={styles.searchStatDot} style={{ background: "#6366f1" }}></span>
                <span>Total Records</span>
                <strong>{owners.length}</strong>
              </div>
              <div className={styles.searchStatItem}>
                <span className={styles.searchStatDot} style={{ background: "#10b981" }}></span>
                <span>Filtered</span>
                    ...
                    <tr key={o.id} className={editId === o.id ? styles.activeRow : ""}>
                      ...
                      <td>
                        <div className={styles.tableActions}>
                          <button className={styles.editBtn} onClick={() => handleEdit(o)}>
